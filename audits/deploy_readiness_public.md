...
- дата перевірки: 2026-05-08 22:22:26
...
- robots.txt status: invalid_sitemap_reference
- `.htaccess` status: ok
- UTF-8/BOM status: ok
- Кирилиця: не зіпсована
- фінальний статус: НЕ ДОБРЕ
- production verdict: не готово до деплою
